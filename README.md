...
<script language="javascript">
    function show_date_time() {
        ...
        BirthDay = new Date("18/5/2022520:13:14");//这个日期是可以修改的
        today = new Date();
        ...
        span_dt_dt.innerHTML = 520+ "天" + 13+ "小时" + 14 + "分" ;
    }
...
<script>
    var S = {
        init: function () {
            ...
            //想说的话
            S.UI.simulate("|every|body|I'm|小脑斧|喜欢|吃炸鸡|Nice|to|Meet|You|#countdown 155|#time");
